...
LABEL maintainer="emmysteven.com"
WORKDIR /
COPY . /
...
- `LABEL maintainer="emmysteven.com"`: This adds a label to the image, specifying the maintainer or creator of the image.
