...
2. Select the following options:
    ...
    - Language: `Java`
    - Spring Boot: `3.1.0`
    - Group: `com.emmysteven` (replace with your desired package name)
...
2. Create a package called `domain` **`src/main/java/com/emmysteven/todo/domain`**
3. Create a package called `common` `src/main/java/com/emmysteven/todo/domain/common`
4. Create a new java class in the `common` package and name it **`BaseEntity.java`,** and add the following piece of code
```java
package com.emmysteven.todo.domain.common;
...
1. Create a package called `entities` `src/main/java/com/emmysteven/todo/domain/entities`
2. Create a new java class in the `entities` package and name it **`Todo.java`,** and add the following piece of code

```java
package com.emmysteven.todo.domain.entities;

import com.emmysteven.todo.domain.common.BaseEntity;
import com.emmysteven.todo.domain.enums.Status;
import jakarta.persistence.*;
...
1. Create a package called `enums` `src/main/java/com/emmysteven/todo/domain/enums`
2. In the package above, create Status enum **`Status.java`,** and add the following piece of code
```java
package com.emmysteven.todo.domain.enums;
...
1. Create a package called `infrastructure` **`src/main/java/com/emmysteven/todo/infrastructure`**
1. Create a package called `repository` `src/main/java/com/emmysteven/todo/infrastructure/repository`
3. Create a new java class in the `repository` package and name it **`TodoRepository.java`,** and add the following piece of code
```java
package com.emmysteven.todo.infrastructure.repository;

import com.emmysteven.todo.domain.entities.Todo;
...
1. `package com.emmysteven.todo.infrastructure.repository;`
...
2. `import com.emmysteven.todo.domain.entities.Todo;`
   This line imports the `Todo` class from the "com.emmysteven.todo.domain.entities" package. The "Todo" class represents a task in a to-do list.
...
1. Create a package called `services` **`src/main/java/com/emmysteven/todo/infrastructure/services`**
2. Create a new java class in the `services` package and name it **`TodoService.java`,** and add the following piece of code

```java
package com.emmysteven.todo.infrastructure.services;

import com.emmysteven.todo.domain.entities.Todo;
import com.emmysteven.todo.infrastructure.repository.TodoRepository;
...
1. Create a `webapi` package **`src/main/java/com/emmysteven/todo/webapi`**
2. Create `controllers` package `src/main/java/com/emmysteven/todo/webapi/controllers`
3. in the `controllers` package, add **`TodoController.java`**, and add the following piece of code

```java
package com.emmysteven.todo.webapi.controllers;

import com.emmysteven.todo.domain.entities.Todo;
import com.emmysteven.todo.infrastructure.services.TodoService;
